...
FULL_PRODUCT_ACTIONS: tuple[ActionDefinition, ...] = (
    *(
    ...
    _action("account.status", BindingContext.GLOBAL, "View account status"),
    _action("account.login", BindingContext.GLOBAL, "Sign in or restore access"),
    _action("entitlement.refresh", BindingContext.GLOBAL, "Retry access check"),
    _action("app.update", BindingContext.GLOBAL, "Check for updates"),
