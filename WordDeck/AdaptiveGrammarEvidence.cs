...
internal static class AdaptiveGrammarEvidenceSelfTest
{
    ...
    private static void WeakGrammarSkillRoutesToGrammar()
    {
        ...
        Require(decision.NextMode == AdaptivePracticeMode.Grammar, "A weak canonical grammar skill must route to direct Grammar practice when Sentence/Reading evidence is merely missing.");
        Require(decision.HasDirectNeed, "Weak canonical Grammar evidence must be marked as a direct practice need.");
    }
