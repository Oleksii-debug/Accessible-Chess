...
FULL_PRODUCT_ACTIONS: tuple[ActionDefinition, ...] = (
    *(
    ...
    _action("pgn.previous_item", BindingContext.DOCUMENT, "Previous GameTree item", "Up"),
    _action("pgn.next_item", BindingContext.DOCUMENT, "Next GameTree item", "Down"),
    _action("pgn.parent_variation", BindingContext.DOCUMENT, "Return to parent variation", "Left"),
