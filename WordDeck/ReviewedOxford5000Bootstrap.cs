...
internal static class ReviewedOxford5000Bootstrap
{
    ...
    public const int ExpectedCanonicalRows = 1065;
    ...
    private static List<CanonicalCandidate> BuildCanonicalRows()
    {
        ...
        AppendVerifiedSlice(result, "oxford5000_source_after_manual_v5_round01_manual-emergency-work-20260820-second-pa_cp0001_rows_0083.tsv", 83, 10000);
