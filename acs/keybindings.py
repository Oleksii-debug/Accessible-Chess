...
DEFAULT_ACTIONS: tuple[ActionDefinition, ...] = (
    ...
    ActionDefinition("analysis.previous_pv", BindingContext.ANALYSIS, "Previous principal variation", "Alt+Up"),
    ActionDefinition("analysis.next_pv", BindingContext.ANALYSIS, "Next principal variation", "Alt+Down"),
    ActionDefinition("analysis.lock_target", BindingContext.ANALYSIS, "Lock or follow analysis target", "Alt+L"),
    ActionDefinition("analysis.explore_pv", BindingContext.ANALYSIS, "Explore selected principal variation", "Alt+Enter"),
    ActionDefinition("analysis.return", BindingContext.ANALYSIS, "Return from principal variation", "Alt+Escape"),
    ...
    ActionDefinition("board.cursor_left", BindingContext.BOARD, "Move board cursor left", "ArrowLeft"),
    ActionDefinition("board.cursor_right", BindingContext.BOARD, "Move board cursor right", "ArrowRight"),
    ActionDefinition("board.cursor_up", BindingContext.BOARD, "Move board cursor up", "ArrowUp"),
    ActionDefinition("board.cursor_down", BindingContext.BOARD, "Move board cursor down", "ArrowDown"),
    ...
    ActionDefinition("board.rank_1", BindingContext.BOARD, "Go to rank 1", "1"),
    ActionDefinition("board.rank_2", BindingContext.BOARD, "Go to rank 2", "2"),
    ActionDefinition("board.rank_3", BindingContext.BOARD, "Go to rank 3", "3"),
    ActionDefinition("board.rank_4", BindingContext.BOARD, "Go to rank 4", "4"),
    ActionDefinition("board.rank_5", BindingContext.BOARD, "Go to rank 5", "5"),
    ActionDefinition("board.rank_6", BindingContext.BOARD, "Go to rank 6", "6"),
    ActionDefinition("board.rank_7", BindingContext.BOARD, "Go to rank 7", "7"),
    ActionDefinition("board.rank_8", BindingContext.BOARD, "Go to rank 8", "8"),
    ActionDefinition("board.file_1", BindingContext.BOARD, "Go to file a", "Shift+1"),
    ActionDefinition("board.file_2", BindingContext.BOARD, "Go to file b", "Shift+2"),
    ActionDefinition("board.file_3", BindingContext.BOARD, "Go to file c", "Shift+3"),
    ActionDefinition("board.file_4", BindingContext.BOARD, "Go to file d", "Shift+4"),
    ActionDefinition("board.file_5", BindingContext.BOARD, "Go to file e", "Shift+5"),
