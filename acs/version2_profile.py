...
Teacher/Classroom, Classes/Education and Remote remain preserved in the repository
but are not made visible by this profile. No chess, PGN, database, book or
training rules are implemented here.
"""
...
def build_version2_menu_spec(
    ...
    *,
    ...
    Training remains keyboard-accessible through the semantic V2 navigation.  Its
    native top-level menu is deliberately not enabled here until reset/confirmation
    can use the same explicit modal contract as the WebView Training surface.
    """
