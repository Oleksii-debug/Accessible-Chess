        ...
        with tempfile.TemporaryDirectory() as root:
            ...
            for index in (137, 311, 487):
                with self.subTest(index=index):
                    ...
                    if index in (311, 487):
                        workflow.next_move()          # e4
                        workflow.enter_variation(0)  # 1.d4 ...
                        workflow.next_move()          # d4
                        workflow.next_move()          # ...d5
                        workflow.enter_variation(0)  # nested 1...Nf6
                        workflow.next_move()          # ...Nf6
