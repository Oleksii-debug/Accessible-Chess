...
3. Preserve all nine locked Product-defect classes; never weaken strict gates for GREEN.
...
6. Preserve ChessBase companion-directory observability and the new manifest verification I/O observability gate: unreadable/hash-failed evidence must remain distinguishable from verified unchanged evidence.
...
8. Extend ChessBase component open/stat/hash failure tests without inventing proprietary decoder semantics.
