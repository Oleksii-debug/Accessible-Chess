...
answers into arbitrary opening moves; it publishes the authored release course
plus representative canonical Diagram/VariationTree examples through the same
BookDocument/Training authority.
"""

from .bookdocument import BookDocument
from .starter_books_training_release import build_release_starter_course
from .starter_structured_examples import augment_starter_course
...
def build_training_ready_starter_course() -> BookDocument:
    ...
    document = augment_starter_course(build_release_starter_course())
