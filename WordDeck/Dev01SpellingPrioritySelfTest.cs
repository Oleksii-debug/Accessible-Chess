...
internal static class Dev01SpellingPrioritySelfTest
{
    public static void Run()
    {
        ...
        Console.WriteLine("WordDeck Spelling priority passed: repeated-error words are prioritized in the real Spelling shuffle path without starving the finite full-coverage cycle, refill repeats are prevented, all canonical scopes remain complete, and persisted statistics stay read-only.");
    }
