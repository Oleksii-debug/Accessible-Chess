...
internal sealed partial class MainForm
{
    internal void ExportUnifiedPersonalProfileInteractive()
    {
        ...
        try
        {
            ...
            AnnounceStatus($"Complete personal profile exported to {dialog.FileName}. Recall, Spelling, Sentence and Story/Narrative Course learning state are included; canonical dictionary, audio, SentencePack and built-in story content are not copied into the profile.");
        }
        catch (Exception ex)
        {
    ...
    internal void ImportUnifiedPersonalProfileInteractive()
    {
        ...
        try
        {
            ...
            string modes = result.StoryImported
                ? "Recall, Spelling, Sentence and Story/Narrative Course state were restored."
                : result.SentenceImported
                    ? "This older profile restored Recall, Spelling and Sentence state; current Story/Narrative Course state was intentionally preserved."
                    : result.SpellingImported
                        ? "This older profile restored Recall and Spelling state; current Sentence and Story/Narrative Course state were intentionally preserved."
                        : "This V0.1 profile restored Recall state; current Spelling, Sentence and Story/Narrative Course state were intentionally preserved.";
