...
FULL_PRODUCT_ACTIONS: tuple[ActionDefinition, ...] = (
    *(
    ...
    _action("teacher.board_lock_toggle", BindingContext.DOCUMENT, "Toggle student board lock"),
    _action("teacher.student_moves_toggle", BindingContext.DOCUMENT, "Toggle student move permission"),
