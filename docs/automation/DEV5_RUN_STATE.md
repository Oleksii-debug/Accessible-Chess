...
LIVE_RACE_RECHECK: DEV1 moved during this run; latest observed PR #68 head 0249f05d9345e8cb1e4063311327a6ff6388aaa1
...
## DEV1 touching-lane snapshot — moving, still non-terminal
Canonical Drive DEV1_RUN_STATE RUN_ID 20260822-0041 still says STATUS=IN_PROGRESS and canonical 10_DEV1_HANDOFF_CURRENT remains stale/non-terminal for the full-product continuation. During this DEV5 run, live PR #68 advanced from c1425c898b3b6d1a4caea6a57a71544ee8582909 to 0249f05d9345e8cb1e4063311327a6ff6388aaa1, four commits ahead. Current exact changed paths are:
...
The new 0249f05d... commit adds accessible PGN/Library/Book/Training presenters over canonical domain services. No exact pull-request workflow runs are observable for 0249f05d.... This live movement proves the RUN_STATE is genuinely not safe to override as stale. SAFE OVERLAP remains mandatory and DEV5 performs no competing full-product Product push.
...
Executable Product checkpoint remains 3dde3a7444c9cf594e92e32f5e084c8969015ad4. Live PR #65 head 23aba247aa47bc2f7aa7051798e1b9c1b84a3621 is eight commits ahead only in docs/codex state files; Product did not move. Validation PR #84 is CLOSED UNMERGED. Exact GREEN evidence remains run 32563847332 / job 97009443566 on merge ref f1134af309c3fe687b039f2aea5c0068b353408c: focused 87/87; unittest 616/616; pytest 694 + 585 subtests; SELFTEST and complete WebView2 diagnostic PASS.

DEV3 3dde3a... diverges from 6fa705... at merge-base e8cd992d306975955784118364ce950963133d7e. Future DEV5 intake must selectively port/revalidate DEV3 ACSDB/Library/Search/recovery/query-plan, PGN publication, Books/Training persistence and signed-64-bit search scalar behavior; no historical whole-branch merge.
...
Reusable full-product Work 6fa705... and accepted Stage1 0fa44233... diverge at e8cd992d.... Correct future assembly is selective: accepted Stage1 semantics + terminal DEV1 full-product presentation package + clean DEV2 GameTree delta + selected exact DEV3 data/backend delta + repaired DEV4 boundaries. Evidence PRs never become integration authority.
...
## Readiness estimates
Stage1 machine integration gates GREEN; last independent overall estimate about 93%, still blocked by fresh Windows release chain and human NVDA. Full-product integrated end-user readiness conservatively ~20-25%. GameTree/domain ~70-75%; ACSDB/Library/Search ~65-70%; full-product UI/Teacher foundation ~20-25% and actively moving; PGN/ChessBase ~25-30% with ten defects; Books/Training ~30-35%; Classroom/Lessons/Assignments/Remote ~10%.

## Next actions
1. DEV1 terminalize current moving full-product package at one exact SHA, synchronize RUN_STATE + 10_DEV1_HANDOFF_CURRENT and publish observable focused/applicable evidence.
