...
internal static class ReviewedOxford5000Bootstrap
{
    ...
    public const int ExpectedCanonicalRows = 990;
    ...
    private static List<CanonicalCandidate> BuildCanonicalRows()
    {
        ...
        AppendVerifiedSlice(result, "oxford5000_source_after_manual_v6_round01_manual-emergency-work-20260820-second-pa_cp0001_rows_0008.tsv", 8, 10000);
