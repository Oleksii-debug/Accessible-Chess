...
internal sealed class ShortcutSettingsForm : Form
{
    ...
    public ShortcutSettingsForm(ShortcutManager manager)
    {
        ...
        resetButton.Click += (_, _) =>
        {
            ...
            RefreshList();
            AnnounceStatus("All rebindable shortcuts were reset to their defaults. Fixed Windows commands remain fixed.");
            _list.Focus();
        };
...
internal sealed class ShortcutCaptureForm : Form
{
    ...
    public ShortcutCaptureForm(string description, Keys current)
    {
        ...
        _value = new TextBox
        {
            ...
            AccessibleDescription = "The currently captured shortcut. Press a new combination or Escape to cancel.",
            TabIndex = 0
        };
