...
ROUTES: tuple[ModuleRoute, ...] = (
    ...
    ModuleRoute("access", {UILanguage.UA: "Доступ і обліковий запис", UILanguage.EN: "Access and account"}, {UILanguage.UA: "Стан доступу, вхід і відновлення без втрати локальних даних", UILanguage.EN: "Access status, sign-in, and recovery without losing local data"}, default_focus_id="entitlement-status", open_action_id="screen.access"),
